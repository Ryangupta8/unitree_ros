...
int main(int argc, char **argv)
{
    ...
    while (ros::ok()){
        ...
        // for(int i=0; i<12; i++){
        //     lowCmd.motorCmd[i].tau = 1.;//lowState.motorState[i].q;
        // }
        // lowCmd.motorCmd[0].tau = -20; // FR Hip 
        // lowCmd.motorCmd[3].tau = ; // FL Hip
        lowCmd.motorCmd[6].tau = 20; // RR Hip
        // lowCmd.motorCmd[9].tau = ; // RL Hip
